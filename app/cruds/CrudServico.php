...
//Daqui pra baixo eu mexi
    ...
    public function editar ($cod_servico, $nome, $email, $telefone, $senha, $rg, $cpf, $num_cnh, $cod_cidade){

        $sql = "UPDATE servico SET nome = '$nome', email = '$email', telefone = '$telefone', senha = '$senha', rg = '$rg', cpf = '$cpf',  num_cnh = '$num_cnh', cod_cidade = $cod_cidade WHERE cod_servico = $cod_servico";
        $this->conexao->exec($sql);
    }
